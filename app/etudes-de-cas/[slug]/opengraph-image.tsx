...
export default async function OgImage({ params }: Props) {
  ...
  const title = projet?.title ?? "Études de cas — Cédric Aimé Fotso"
  const tagline = projet?.tagline ?? "Design · Développement web · Stratégie digitale"
  ...
  return new ImageResponse(
    (
      <div style={S.root}>
        <div style={S.accent} />
        <div style={S.body}>
          <p style={S.eyebrow}>Étude de cas</p>
